...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        supportActionBar?.title = "Choose pics (${chosenImageUris.size} / n${numImagesRequired})"
        btnSave.isEnabled = shouldEnableSaveButton() 
    }
    private fun saveDataToFirebase() {
        ...
        db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
            if (document != null && document.data != null) {
                ...
                handleAllImageUploading(customGameName)
            }
        }.addOnFailureListener {exception ->
            Log.e(TAG, "Encountered erro while saving memory game", exception)
    ...
    private fun handleAllImageUploading(gameName: String) {
